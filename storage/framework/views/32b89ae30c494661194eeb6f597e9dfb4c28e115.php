...
<body class="theme-red">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
					<img src="<?php echo e(Auth::user()->profile_image); ?>" onerror="this.src='<?php echo e(asset('public/images/user.png')); ?>'"  width="48" height="48" alt="User" >
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
							...
							<?php if(Auth::user()->isAdmin!=env('ISADMIN')): ?>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li <?php if(Request::url() == URL::to('franchisee')): ?> class="active" <?php endif; ?>>
                                <a href="<?php echo e(URL::to('franchisee')); ?>">Franchisee</a>
                            </li>                            
                        </ul>
						<?php else: ?>
						<ul class="ml-menu">
                            <li <?php if(Request::url() == URL::to('customer')): ?> class="active" <?php endif; ?>>
                                <a href="<?php echo e(URL::to('customer')); ?>">Customer</a>
                            </li>                            
                        </ul>
						<?php endif; ?>
                    </li>
				...
				<div class="modal-body">
					<form name="frmUpdateProfile" id="frmUpdateProfile" enctype="multipart/form-data">
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="fullname" name="fullname" class="form-control" placeholder="Enter your fullname" value="<?php echo e(Auth::user()->name); ?>">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="mobile" name="mobile" class="form-control" placeholder="Enter your mobile number" value="<?php echo e(Auth::user()->mobile); ?>">
								</div>
							</div>
						</div>
				...
				<div class="modal-body">
					<form name="frmUpdateBankDetails" id="frmUpdateBankDetails" enctype="multipart/form-data">
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="accountName" name="accountName" class="form-control" placeholder="Enter your account name" value="<?php echo e(Auth::user()->account_name); ?>">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="accountNumber" class="form-control" placeholder="Enter your account number" name="accountNumber" required value="<?php echo e(Auth::user()->account_number); ?>">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="bankName" name="bankName" class="form-control" placeholder="Enter bank name" value="<?php echo e(Auth::user()->bank_name); ?>">
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="form-group form-group1">
								<div class="form-line">
									<input type="text" id="bankIFSC" name="bankIFSC" class="form-control" placeholder="Enter bank IFSC code" value="<?php echo e(Auth::user()->ifsc_code); ?>">
								</div>
							</div>
						</div>
